...
namespace FMaterialBakingModuleImpl
{
	...
	struct FRenderItemKey
	{
		...
		FRenderItemKey(const FMeshRenderData* InRenderData, const FIntPoint& InRenderSize)
...
void FMaterialBakingModule::BakeMaterials(const TArray<FMaterialData*>& MaterialSettings, const TArray<FMeshRenderData*>& MeshSettings, TArray<FBakeOutput>& Output)
{
...
#if (ENGINE_MAJOR_VERSION > 4)
void FMaterialBakingModule::BakeMaterials(const TArray<FMaterialDataEx*>& MaterialSettings, const TArray<FMeshRenderData*>& MeshSettings, TArray<FBakeOutputEx>& Output)
{
		...
		[&](int32 MaterialIndex)
	{
		...
		const FMeshRenderData* CurrentMeshSettings = MeshSettings[MaterialIndex];
