...
class MTLBAKING_API FMaterialBakingModule : public IMaterialBakingModule
{
public:
	...
	virtual void BakeMaterials(const TArray<FMaterialData*>& MaterialSettings, const TArray<FMeshRenderData*>& MeshSettings, TArray<FBakeOutput>& Output) override;

	/** Bakes out material properties according to extended MaterialSettings using MeshSettings and stores the output in Output */
	virtual void BakeMaterials(const TArray<FMaterialDataEx*>& MaterialSettings, const TArray<FMeshRenderData*>& MeshSettings, TArray<FBakeOutputEx>& Output) override;
