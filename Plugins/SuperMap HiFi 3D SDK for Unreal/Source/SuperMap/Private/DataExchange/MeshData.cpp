...
namespace SuperMapSDK
{
	namespace UnrealEngine
	{
		...
		{
			FUeMeshData::FUeMeshData(const UStaticMesh* StaticMesh, const UStaticMeshComponent* StaticMeshComponent, int32 LODIndex)
				: Parent(nullptr)
				, LODIndex(LODIndex)
#if WITH_EDITOR
				, LightMap(nullptr)
...
#endif
			{
				...
				{
					Name = FNameUtility::GetName(StaticMeshComponent);
			...
			FUeMeshData::FUeMeshData(const USkeletalMesh* SkeletalMesh, const USkeletalMeshComponent* SkeletalMeshComponent, int32 LODIndex)
				: Parent(nullptr)
				, LODIndex(LODIndex)
#if WITH_EDITOR
				, LightMap(nullptr)
...
#endif
			{
				...
				{
					Name = FNameUtility::GetName(SkeletalMeshComponent);
			...
			const FUeMeshData* FUeMeshData::GetParent() const
			{
